...
import { PlusCircle, SlidersHorizontal, Loader2, ClipboardList } from 'lucide-react';
...
export default function QuestionnairesPage() {
  ...
  const lastQuestionnaireRef = useCallback((node: HTMLDivElement) => {
    if (isLoading) return;
  ...
  const currentSortOption = SORT_OPTIONS.find(option => option.value === sortValue);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
              ...
              <DropdownMenuRadioGroup value={sortValue} onValueChange={changeSort}>
      ...
      {!isLoading && questionnaires.length === 0 && !error && (
